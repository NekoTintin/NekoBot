...
class Tools(commands.GroupCog, group_name="tools"):
    ...
    async def version(self, react: discord.Interaction) -> None:
        await react.response.send_message(f"Je suis en version: **{var.version}** !", ephemeral=True)
    ...
    async def git(self, react: discord.Interaction):
        message = Embed(title="Lien du GitHub:", color=0xfbfcfc).add_field(name="Repo de NekoBot", value="https://github.com/Tintin361/NekoBot")
